...
public struct CreatePostRequestBody: Codable, JSONEncodable, Hashable {

    public var contentElementFiles: [FileDescriptor]
    public var caption: String
    public var hashtags: [String]
    public var scheduledPublicationTimestamp: Double?
    public var expirationTimestamp: Double?

    public init(contentElementFiles: [FileDescriptor], caption: String, hashtags: [String], scheduledPublicationTimestamp: Double? = nil, expirationTimestamp: Double? = nil) {
        self.contentElementFiles = contentElementFiles
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encode(contentElementFiles, forKey: .contentElementFiles)
