//
// DeletePublishingChannelRequestBody.swift
//
...
public struct DeletePublishingChannelRequestBody: Codable, JSONEncodable, Hashable {

    public var publishingChannelId: String

    public init(publishingChannelId: String) {
