//
// GetPublishedItemByIdSuccessPublishedItem.swift
//
...
public struct GetPublishedItemByIdSuccessPublishedItem: Codable, JSONEncodable, Hashable {

    public var type: PublishedItemTypeSHOPITEM
    ...
    public var sharedItem: SharedShopItemSharedItem
    public var renderableShopItemType: RenderableShopItemTypePURCHASEDSHOPITEMDETAILS
    public var title: String
    public var price: Double
    public var purchasedMediaElementsMetadata: RenderableUserFollowers
    public var purchasedMediaElements: [MediaElement]

    public init(type: PublishedItemTypeSHOPITEM, id: String, authorUserId: String, caption: String, creationTimestamp: Double, scheduledPublicationTimestamp: Double, expirationTimestamp: Double? = nil, idOfPublishedItemBeingShared: String? = nil, host: PublishedItemHost, hashtags: [String], likes: RenderableUserFollowers, comments: RenderableUserFollowers, isLikedByClient: Bool, isSavedByClient: Bool, mediaElements: [MediaElement], sharedItem: SharedShopItemSharedItem, renderableShopItemType: RenderableShopItemTypePURCHASEDSHOPITEMDETAILS, title: String, price: Double, purchasedMediaElementsMetadata: RenderableUserFollowers, purchasedMediaElements: [MediaElement]) {
        self.type = type
        self.id = id
        ...
        self.purchasedMediaElements = purchasedMediaElements
    }
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encode(purchasedMediaElements, forKey: .purchasedMediaElements)
    }
}
