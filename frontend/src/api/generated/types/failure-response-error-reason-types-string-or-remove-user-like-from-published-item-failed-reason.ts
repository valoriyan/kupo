 ...
 *
 * @export
 * @interface FailureResponseErrorReasonTypesStringOrRemoveUserLikeFromPublishedItemFailedReason
 */
export interface FailureResponseErrorReasonTypesStringOrRemoveUserLikeFromPublishedItemFailedReason {
  /**
   *
   * @type {EitherTypeFailure}
   * @memberof FailureResponseErrorReasonTypesStringOrRemoveUserLikeFromPublishedItemFailedReason
   */
  type: EitherTypeFailure;
  /**
   *
