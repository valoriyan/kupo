 ...
 *
 * @export
 * @interface FailureResponseErrorReasonTypesStringOrCreatePublishingChannelFailedReason
 */
export interface FailureResponseErrorReasonTypesStringOrCreatePublishingChannelFailedReason {
  /**
   *
   * @type {EitherTypeFailure}
   * @memberof FailureResponseErrorReasonTypesStringOrCreatePublishingChannelFailedReason
   */
  type: EitherTypeFailure;
  /**
   *
