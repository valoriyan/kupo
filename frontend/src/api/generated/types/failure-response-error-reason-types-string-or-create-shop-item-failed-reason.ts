 ...
 *
 * @export
 * @interface FailureResponseErrorReasonTypesStringOrCreateShopItemFailedReason
 */
export interface FailureResponseErrorReasonTypesStringOrCreateShopItemFailedReason {
  /**
   *
   * @type {EitherTypeFailure}
   * @memberof FailureResponseErrorReasonTypesStringOrCreateShopItemFailedReason
   */
  type: EitherTypeFailure;
  /**
   *
