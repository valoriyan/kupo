 ...
 *
 * @export
 * @interface FailureResponseUserUnsavesPublishedItemFailedError
 */
export interface FailureResponseUserUnsavesPublishedItemFailedError {
  /**
   *
   * @type {string}
   * @memberof FailureResponseUserUnsavesPublishedItemFailedError
   */
