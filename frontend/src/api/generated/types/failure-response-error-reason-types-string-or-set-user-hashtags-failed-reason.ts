 ...
 *
 * @export
 * @interface FailureResponseErrorReasonTypesStringOrSetUserHashtagsFailedReason
 */
export interface FailureResponseErrorReasonTypesStringOrSetUserHashtagsFailedReason {
  /**
   *
   * @type {EitherTypeFailure}
   * @memberof FailureResponseErrorReasonTypesStringOrSetUserHashtagsFailedReason
   */
  type: EitherTypeFailure;
  /**
   *
