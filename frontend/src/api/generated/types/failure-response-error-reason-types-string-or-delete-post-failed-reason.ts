 ...
 *
 * @export
 * @interface FailureResponseErrorReasonTypesStringOrDeletePostFailedReason
 */
export interface FailureResponseErrorReasonTypesStringOrDeletePostFailedReason {
  /**
   *
   * @type {EitherTypeFailure}
   * @memberof FailureResponseErrorReasonTypesStringOrDeletePostFailedReason
   */
  type: EitherTypeFailure;
  /**
   *
