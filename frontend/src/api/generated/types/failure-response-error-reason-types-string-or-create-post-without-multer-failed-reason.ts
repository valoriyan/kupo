 ...
 *
 * @export
 * @interface FailureResponseErrorReasonTypesStringOrCreatePostWithoutMulterFailedReason
 */
export interface FailureResponseErrorReasonTypesStringOrCreatePostWithoutMulterFailedReason {
  /**
   *
   * @type {EitherTypeFailure}
   * @memberof FailureResponseErrorReasonTypesStringOrCreatePostWithoutMulterFailedReason
   */
  type: EitherTypeFailure;
  /**
   *
