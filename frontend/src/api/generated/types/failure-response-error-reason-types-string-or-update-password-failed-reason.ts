 ...
 *
 * @export
 * @interface FailureResponseErrorReasonTypesStringOrUpdatePasswordFailedReason
 */
export interface FailureResponseErrorReasonTypesStringOrUpdatePasswordFailedReason {
  /**
   *
   * @type {EitherTypeFailure}
   * @memberof FailureResponseErrorReasonTypesStringOrUpdatePasswordFailedReason
   */
  type: EitherTypeFailure;
  /**
   *
