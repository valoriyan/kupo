 ...
 *
 * @export
 * @interface FailureResponseErrorReasonTypesStringOrUserUnsavesPublishedItemFailedReason
 */
export interface FailureResponseErrorReasonTypesStringOrUserUnsavesPublishedItemFailedReason {
  /**
   *
   * @type {EitherTypeFailure}
   * @memberof FailureResponseErrorReasonTypesStringOrUserUnsavesPublishedItemFailedReason
   */
  type: EitherTypeFailure;
  /**
   *
