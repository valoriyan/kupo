 ...
 *
 * @export
 * @interface FailureResponseErrorReasonTypesStringOrElevateUserToAdminFailedReason
 */
export interface FailureResponseErrorReasonTypesStringOrElevateUserToAdminFailedReason {
  /**
   *
   * @type {EitherTypeFailure}
   * @memberof FailureResponseErrorReasonTypesStringOrElevateUserToAdminFailedReason
   */
  type: EitherTypeFailure;
  /**
   *
