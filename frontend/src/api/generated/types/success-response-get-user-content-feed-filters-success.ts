 ...
 *
 * @export
 * @interface SuccessResponseGetUserContentFeedFiltersSuccess
 */
export interface SuccessResponseGetUserContentFeedFiltersSuccess {
  /**
   *
   * @type {EitherTypeSuccess}
   * @memberof SuccessResponseGetUserContentFeedFiltersSuccess
   */
  type: EitherTypeSuccess;
  /**
   *
