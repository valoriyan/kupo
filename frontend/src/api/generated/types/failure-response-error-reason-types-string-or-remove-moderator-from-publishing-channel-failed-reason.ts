 ...
 *
 * @export
 * @interface FailureResponseErrorReasonTypesStringOrRemoveModeratorFromPublishingChannelFailedReason
 */
export interface FailureResponseErrorReasonTypesStringOrRemoveModeratorFromPublishingChannelFailedReason {
  /**
   *
   * @type {EitherTypeFailure}
   * @memberof FailureResponseErrorReasonTypesStringOrRemoveModeratorFromPublishingChannelFailedReason
   */
  type: EitherTypeFailure;
  /**
   *
