 ...
 *
 * @export
 * @interface FailureResponseErrorReasonTypesStringOrGetPublishingChannelsFollowedByUserIdFailedReason
 */
export interface FailureResponseErrorReasonTypesStringOrGetPublishingChannelsFollowedByUserIdFailedReason {
  /**
   *
   * @type {EitherTypeFailure}
   * @memberof FailureResponseErrorReasonTypesStringOrGetPublishingChannelsFollowedByUserIdFailedReason
   */
  type: EitherTypeFailure;
  /**
   *
