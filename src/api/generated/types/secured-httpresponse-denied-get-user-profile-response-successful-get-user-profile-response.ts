 ...
 *
 * @export
 * @interface SecuredHTTPResponseDeniedGetUserProfileResponseSuccessfulGetUserProfileResponse
 */
export interface SecuredHTTPResponseDeniedGetUserProfileResponseSuccessfulGetUserProfileResponse {
  /**
   *
   * @type {DeniedGetUserProfileResponse | FailedAuthResponse}
