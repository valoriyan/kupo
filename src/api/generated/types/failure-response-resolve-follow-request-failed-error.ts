 ...
 *
 * @export
 * @interface FailureResponseResolveFollowRequestFailedError
 */
export interface FailureResponseResolveFollowRequestFailedError {
  /**
   *
   * @type {string}
   * @memberof FailureResponseResolveFollowRequestFailedError
   */
