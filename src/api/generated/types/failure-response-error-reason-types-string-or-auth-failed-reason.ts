 ...
 *
 * @export
 * @interface FailureResponseErrorReasonTypesStringOrAuthFailedReason
 */
export interface FailureResponseErrorReasonTypesStringOrAuthFailedReason {
  /**
   *
   * @type {EitherTypeFailure}
   * @memberof FailureResponseErrorReasonTypesStringOrAuthFailedReason
   */
  type: EitherTypeFailure;
  /**
   *
