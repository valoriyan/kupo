 ...
 *
 * @export
 * @interface FailureResponseDeleteShopItemFailedError
 */
export interface FailureResponseDeleteShopItemFailedError {
  /**
   *
   * @type {string}
   * @memberof FailureResponseDeleteShopItemFailedError
   */
