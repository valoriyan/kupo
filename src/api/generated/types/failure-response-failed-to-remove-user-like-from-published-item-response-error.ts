 ...
 *
 * @export
 * @interface FailureResponseFailedToRemoveUserLikeFromPublishedItemResponseError
 */
export interface FailureResponseFailedToRemoveUserLikeFromPublishedItemResponseError {
  /**
   *
   * @type {string}
   * @memberof FailureResponseFailedToRemoveUserLikeFromPublishedItemResponseError
   */
