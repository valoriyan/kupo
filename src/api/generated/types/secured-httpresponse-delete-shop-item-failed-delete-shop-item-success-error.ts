 ...
 *
 * @export
 * @interface SecuredHTTPResponseDeleteShopItemFailedDeleteShopItemSuccessError
 */
export interface SecuredHTTPResponseDeleteShopItemFailedDeleteShopItemSuccessError {
  /**
   *
   * @type {string}
   * @memberof SecuredHTTPResponseDeleteShopItemFailedDeleteShopItemSuccessError
   */
