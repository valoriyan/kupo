 ...
 *
 * @export
 * @interface FailureResponseGetPostsScheduledByUserFailedError
 */
export interface FailureResponseGetPostsScheduledByUserFailedError {
  /**
   *
   * @type {string}
   * @memberof FailureResponseGetPostsScheduledByUserFailedError
   */
