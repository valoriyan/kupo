 ...
 *
 * @export
 * @interface FailureResponseUserSavesPublishedItemFailedError
 */
export interface FailureResponseUserSavesPublishedItemFailedError {
  /**
   *
   * @type {string}
   * @memberof FailureResponseUserSavesPublishedItemFailedError
   */
