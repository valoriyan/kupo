 ...
 *
 * @export
 * @interface SecuredHTTPResponseDeletePostFailedDeletePostSuccessError
 */
export interface SecuredHTTPResponseDeletePostFailedDeletePostSuccessError {
  /**
   *
   * @type {string}
   * @memberof SecuredHTTPResponseDeletePostFailedDeletePostSuccessError
   */
