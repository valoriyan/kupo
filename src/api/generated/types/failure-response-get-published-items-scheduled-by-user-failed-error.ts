 ...
 *
 * @export
 * @interface FailureResponseGetPublishedItemsScheduledByUserFailedError
 */
export interface FailureResponseGetPublishedItemsScheduledByUserFailedError {
  /**
   *
   * @type {string}
   * @memberof FailureResponseGetPublishedItemsScheduledByUserFailedError
   */
