 ...
 *
 * @export
 * @interface SuccessResponseGetPublishingChannelByIdSuccess
 */
export interface SuccessResponseGetPublishingChannelByIdSuccess {
  /**
   *
   * @type {EitherTypeSuccess}
   * @memberof SuccessResponseGetPublishingChannelByIdSuccess
   */
  type: EitherTypeSuccess;
  /**
   *
