...
export class PaymentProcessingService {
    private static SECURION_PAY_PRIVATE_KEY: string = getEnvironmentVariable("SECURION_PAY_PRIVATE_KEY");
    public static securionPayApi = securionPay(PaymentProcessingService.SECURION_PAY_PRIVATE_KEY);
    ...
    async chargeCustomer({
        ...
        CREDIT_CARD_VERIFICATION_CARD: string;
        ...
        cvc: CREDIT_CARD_VERIFICATION_CARD,
