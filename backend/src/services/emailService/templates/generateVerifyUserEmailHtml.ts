export function generateVerifyUserEmailHtml({
  verifyUserEmailUrlWithToken,
}: {
  verifyUserEmailUrlWithToken: string;
}) {
  return `
  <!doctype html>
  <html>
                              ...
                              <tr>
                                <td align="left">
                                  <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                    <tbody>
                                      <tr>
                                        <td> <a href="${verifyUserEmailUrlWithToken}" target="_blank">Confirm Email</a> </td>
                                      </tr>
                                    </tbody>
                                  </table>
                                </td>
