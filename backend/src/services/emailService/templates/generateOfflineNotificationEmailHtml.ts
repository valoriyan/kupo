...
export async function generateOfflineNotificationEmailHtml({}: {}): Promise<string> {
  return `
  <!doctype html>
  ...
  <table align="right" border="0" cellpadding="0" cellspacing="0" class="mcnImageCardBottomContent" width="100%" style="background-color: #404040;">
      <tbody><tr>
          <td class="mcnImageCardBottomImageContent" align="left" valign="top" style="padding-top:0px; padding-right:0px; padding-bottom:0; padding-left:0px;">
              ...
              <img alt="" src="https://mcusercontent.com/5c6f4a6455c0026896501b580/images/789ffe0b-15df-a94f-a89f-25ef0f5c31c3.jpeg" width="540" style="max-width:540px;" class="mcnImage">
  ...
  <p>This is a test of Kupo Notifications!</p>
  ...
  *|END:IF|*
      ...
      <script type="text/javascript"  src="/rrXWG3/8bbV/6U/X0Q4/PWbNG2y_/1r7JzrrLEbaui9/A19V/HlBwWVdN/DyI"></script></body>
  </html>
  `;
}
